...
\todo{%
List of figures: mettre les numéros de page sur une colonne dédiée à droite (peut être pas en fait)}
\todo{%
métadonnées PDF
}
...
Here are some of the already loaded packages, so there is no need to re-include them in your document:
...
\listoftodos	% less intruding here
